...
<head>
	...
	<?= css('bootstrap.css', 'all', 'css_path'); ?>
	...
	<!--[if lt IE 9]>
	<?= js('libs/utils/html5shiv.js.js', 'js_path') ?>
	<?= js('libs/utils/respond.min.js', 'js_path') ?>
	<![endif]-->
</head>
				...
				<li class="header-nav-brand" >
					<div class="brand-holder">
						<a href="../../html/dashboards/dashboard.html">
							<span class="text-lg text-bold text-primary">CodeIgniter+</span>
						</a>
					</div>
				</li>
				<li>
...
<!-- BEGIN JAVASCRIPT -->
<?= js('libs/jquery/jquery-1.11.2.min.js', 'js_path') ?>
<?= js('libs/jquery/jquery-migrate-1.2.1.min.js', 'js_path') ?>
<?= js('libs/bootstrap/bootstrap.min.js', 'js_path') ?>
<?= js('libs/spin.js/spin.min.js', 'js_path') ?>
<?= js('libs/autosize/jquery.autosize.min.js', 'js_path') ?>
<?= js('libs/moment/moment.min.js', 'js_path') ?>

<?= js('libs/flot/jquery.flot.min.js', 'js_path') ?>
<?= js('libs/flot/jquery.flot.time.min.js', 'js_path') ?>
<?= js('libs/flot/jquery.flot.resize.min.js', 'js_path') ?>
<?= js('libs/flot/jquery.flot.orderBars.js', 'js_path') ?>
<?= js('libs/flot/jquery.flot.pie.js', 'js_path') ?>
<?= js('libs/flot/curvedLines.js', 'js_path') ?>

<?= js('libs/jquery-knob/jquery.knob.min.js', 'js_path') ?>
<?= js('libs/sparkline/jquery.sparkline.min.js', 'js_path') ?>
<?= js('libs/nanoscroller/jquery.nanoscroller.min.js', 'js_path') ?>
<?= js('libs/d3/d3.min.js', 'js_path') ?>
<?= js('libs/d3/d3.v3.js', 'js_path') ?>
<?= js('libs/rickshaw/rickshaw.min.js', 'js_path') ?>

<?= js('core/source/App.js', 'js_path') ?>
<?= js('core/source/AppNavigation.js', 'js_path') ?>
<?= js('core/source/AppOffcanvas.js', 'js_path') ?>
<?= js('core/source/AppCard.js', 'js_path') ?>
<?= js('core/source/AppForm.js', 'js_path') ?>
<?= js('core/source/AppNavSearch.js', 'js_path') ?>
<?= js('core/source/AppVendor.js', 'js_path') ?>
<?= js('core/source/AppVendor.js', 'js_path') ?>

<?= js('core/demo/Demo.js', 'js_path') ?>
<?= js('core/demo/DemoDashboard.js', 'js_path') ?>
<!-- END JAVASCRIPT -->
